        ...
        <div className="container">
          <div className="article__inner">
            ...
            <div className="article__content">
                ...
                {details}
                {
                  urlArticle ? (
                    <p className="article__text">
                      <a className="links__link" href={urlArticle} rel="nofollow noopener noreferrer" target="_blank">
              ...
              {
                urlYoutube ? (
                  <a className="youtube_link" href={urlYoutube} rel="nofollow noopener noreferrer" target="_blank">
                    <svg width="25" height="18" viewBox="0 0 25 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M23.9984 2.94352C23.7224 1.8832 22.9092 1.04825 21.8765 0.764874C20.005 0.249878 12.5 0.249878 12.5 0.249878C12.5 0.249878 4.99495 0.249878 3.12336 0.764874C2.09068 1.04825 1.27741 1.8832 1.00141 2.94352C0.5 4.86523 0.5 8.87488 0.5 8.87488C0.5 8.87488 0.5 12.8844 1.00141 14.8062C1.27741 15.8666 2.09068 16.7015 3.12336 16.985C4.99495 17.4999 12.5 17.4999 12.5 17.4999C12.5 17.4999 20.005 17.4999 21.8765 16.985C22.9092 16.7015 23.7224 15.8666 23.9984 14.8062C24.5 12.8844 24.5 8.87488 24.5 8.87488C24.5 8.87488 24.5 4.86523 23.9984 2.94352" fill="white" />
                      <path d="M10.25 13V5.5L16.25 9.25014L10.25 13Z" fill="#FF0000" />
                    </svg>
                    <span>Watch</span>
                  </a>
                ) : null
...
export default SingleLaunchLayout;