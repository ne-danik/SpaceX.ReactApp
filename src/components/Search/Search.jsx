...
const Search = () => {
  return (
    <div className="search">
      ...
      <button type="submit" className="input__btn input__btn_filter">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="14" y="16" width="6" height="2" rx="1" fill="white" />
          <rect x="4" y="16" width="2" height="2" rx="1" fill="white" />
          <path fillRule="evenodd" clipRule="evenodd" d="M10 20C11.6569 20 13 18.6569 13 17C13 15.3431 11.6569 14 10 14C8.34315 14 7 15.3431 7 17C7 18.6569 8.34315 20 10 20ZM10 18C10.5523 18 11 17.5523 11 17C11 16.4477 10.5523 16 10 16C9.44772 16 9 16.4477 9 17C9 17.5523 9.44772 18 10 18Z" fill="white" />
          <rect x="4" y="6" width="6" height="2" rx="1" fill="white" />
          <rect x="18" y="6" width="2" height="2" rx="1" fill="white" />
          <path fillRule="evenodd" clipRule="evenodd" d="M14 10C15.6569 10 17 8.65685 17 7C17 5.34315 15.6569 4 14 4C12.3431 4 11 5.34315 11 7C11 8.65685 12.3431 10 14 10ZM14 8C14.5523 8 15 7.55228 15 7C15 6.44772 14.5523 6 14 6C13.4477 6 13 6.44772 13 7C13 7.55228 13.4477 8 14 8Z" fill="white" />
        </svg>
      </button>
      <button type="submit" className="input__btn input__btn_search">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
